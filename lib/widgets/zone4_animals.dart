...
class Zone4Animals extends StatefulWidget {
  const Zone4Animals({Key key}) : super(key: key);
                ...
                (context, index) {
                  return Padding(
                    ...
                    child: animalDetailCard(
                      isBongo: index==3? true:false,
                      isDuiker: index==0? true:false,
                      isBrocketDeer: index==6? true:false,
                      isGiantHog: index==5? true:false,
                      isNileBuffalo: index==4? true:false,
                      name: animalNamesZone4[index],
                      italicName: scientificNames[index],
                      description: descriptionsZone4[index],
                      imgPath: animalImagesZone4[index],
                    ),
                  );
                },
                childCount: animalNamesZone4.length,
              ),
            ),
          ),
        ],
